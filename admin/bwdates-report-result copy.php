...
?>
    ...
    <head>
        ...
        <title>BBERS | B/w Dates Report</title>
                                ...
                                <div class="table-responsive">
                                    <form name="assignto" method="post">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php $query = mysqli_query($con, "select * from tblemergencyreport where  date(tblemergencyreport.postingDate) between '$fdate' and '$tdate'
                                                    ");
                                                $cnt = 1;
