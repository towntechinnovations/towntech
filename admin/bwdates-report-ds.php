        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="index3.html" class="brand-link">
                    <img src="img/AdminLTELogo.png" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item menu-open">
                                        ...
                                        <ul class="nav nav-treeview">
                                            <li class="nav-item">
                                                <a href="bwdates-report-ds.php" class="nav-link active">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>B/w Dates</p>
                                                </a>
                                            </li>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">B/w Dates Report Date Selection</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
